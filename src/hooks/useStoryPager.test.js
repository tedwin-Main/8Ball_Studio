...
test( 'Intro-to-Studio has longer duration than standard page transitions for pool break realism', () =>
{
  assert.ok(
    STORY_TIMING.navigation.introToStudioSeconds > STORY_TIMING.navigation.defaultEdgeSeconds,
    'Cinematic pool break requires longer duration for realistic spread',
  )
} )
